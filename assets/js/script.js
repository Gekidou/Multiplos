...
const numero = window.prompt(
  "Ingrese N°, para obtener su tabla de multiplicacion y factorial"
);
const numero_parseado = parseInt(numero);
if (
  typeof numero_parseado === "NaN" ||
  isNaN(numero_parseado) ||
  numero_parseado < MIN_NUM ||
  numero_parseado > MAX_NUM
) {
  window.alert(
    "Porfavor, Ingrese N° y este debe ser mayor o igual a 1 y menor o igual a 20."
  );
  throw new Error(
    "Porfavor, Ingrese N° y este debe ser mayor o igual a 1 y menor o igual a 20. Stop script!!"
  );
}
